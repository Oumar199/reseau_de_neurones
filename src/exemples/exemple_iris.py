"""Effectuons des tests sur les données iris
"""
from typing import List
from src.tenseurs import np
import pandas as pd
...
class TestIris(Test):
    """Classe permettant d'effectuer les tests sur les données des fleurs d'iris."""
    ...
    def test(
        ...
        iris["species"] = pd.Categorical(
            iris["species"], categories=["setosa", "versicolor", "virginica"]
        )
        ...
        print("Perte sur les données de test IRIS : ", loss.loss(predictions, y_test))  # type: ignore
